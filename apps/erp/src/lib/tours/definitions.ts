...
export const TOUR_DEFINITIONS: Record<string, TourDefinition> = {
  ...
  'inicio-dashboard': {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Los tres indicadores superiores muestran: <strong>ingresos del día</strong>, <strong>productos en catálogo</strong> y <strong>alertas de stock bajo</strong>. Se actualizan en tiempo real cada vez que se registra una venta.',
        narration: 'Los indicadores del día se actualizan en tiempo real con cada venta registrada.',
      },
      {
        title: 'Posición financiera',
        description: 'La sección <strong>Posición Financiera</strong> muestra el saldo en bóveda, el total por pagar a proveedores y el saldo a favor de la sucursal. Si eres GERENTE, ves el consolidado de todas las sucursales.',
      ...
      {
        title: 'Top productos y recordatorios',
        description: 'A la derecha ves el <strong>ranking ABC de productos</strong>, los <strong>recordatorios próximos</strong> (CRM) y la <strong>actividad reciente</strong> con las últimas ventas registradas.',
        narration: 'El panel derecho muestra ranking de productos, recordatorios y actividad reciente.',
      },
      {
  ...
  'pos-venta-contado': {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Elige cómo paga el cliente: <strong>Efectivo</strong>, <strong>QR</strong>, o <strong>Mixto</strong> (parte efectivo + parte QR). En efectivo, escribe el monto recibido para calcular el vuelto.',
        element: '[data-tour="pos-payment"]',
        narration: 'Selecciona el método de pago: efectivo, QR o mixto.',
        side: 'top',
      },
      {
        title: '¡Listo para cobrar!',
        description: 'Presiona <strong>Cobrar</strong> para finalizar. El sistema descuenta el stock, registra en el Kardex, genera el ticket y actualiza la caja automáticamente. <br><br>💡 <em>Atajo: <kbd>F9</kbd> cobra directamente desde el teclado.</em>',
        element: '[data-tour="pos-checkout"]',
        narration: 'Presiona Cobrar para finalizar. El sistema registra todo automáticamente.',
        side: 'top',
      },
    ],
  },
  ...
  'pos-venta-credito': {
    ...
    steps: [
      ...
      {
        title: 'Elegir "Cuotas" como pago',
        description: 'En el método de pago, selecciona <strong>"Cuotas"</strong>. Elige el número de cuotas (1 a 12). El sistema calcula el monto por cuota y la fecha de cada pago automáticamente.',
        element: '[data-tour="pos-payment"]',
        narration: 'Elige cuotas como método de pago y selecciona el número de cuotas.',
        side: 'top',
      },
      {
        title: 'Adelanto inicial (opcional)',
        description: 'Puedes registrar un <strong>adelanto</strong> si el cliente paga algo ahora. Este monto se descuenta del total a financiar.',
        element: '[data-tour="pos-payment"]',
        narration: 'Si el cliente paga un adelanto, regístralo aquí.',
        side: 'top',
      },
      {
